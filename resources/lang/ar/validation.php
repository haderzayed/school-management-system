...
return [
    ...
    'attributes' => [
        ...
        'grade_id'=>'اسم المرحله',
        'class_id'=>'اسم الصف',

        'father_name_ar'=>' أسم الاب باللغه العربيه',
        'father_name_en'=>' أسم الاب باللغه الانجليزيه',
        'job_father_ar'=>' وظيفة الاب باللغه الانجليزيه',
        'job_father_en'=>'وظيفة الاب باللغه العربيه',
        'national_id_father'=>'الرقم القومي للاب ' ,
        'passport_id_father'=>'جواز السفر للاب ',
        'phone_father'=>'هاتف الاب',
        'nationality_father_id'=>'جنسيه الاب',
        'blood_type_father_id'=>'فصيلة دم الاب',
        'religion_father_id'=>'ديانة الاب',
        'address_father'=>'عنوان الاب',

        'mother_name_ar'=>' أسم الام باللغه العربيه',
        'mother_name_en'=>'أسم الام باللغه الانجليزيه',
        'job_mother_ar'=>' وظيفة الام باللغه الانجليزيه',
        'job_mother_en'=>'وظيفة الام باللغه العربيه',
        'national_id_mother '=>'الرقم القومي للام' ,
        'passport_id_mother'=>'جواز السفر للام',
        ...
        'name_en'=>'الاسم باللغه الاجليزيه',
        'gender_id'=>'الجنس',
